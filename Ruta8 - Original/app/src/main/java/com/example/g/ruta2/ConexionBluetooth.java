...
/**
 * Created by CIDETEC on 12/01/2017.
 */

public class ConexionBluetooth extends ActionBarActivity {
    Button btnPaired;
    ListView devicelist;
    //Bluetooth
    ...
    private AdapterView.OnItemClickListener myListClickListener = new AdapterView.OnItemClickListener()
    {
        public void onItemClick (AdapterView<?> av, View v, int arg2, long arg3)
        {
            ...
            Intent i = new Intent(ConexionBluetooth.this, EnvioDatosBluetooth.class);
